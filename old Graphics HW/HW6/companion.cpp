...
void Companion::cube()
{
    ...
    //  Cube
    glBindTexture(GL_TEXTURE_2D, texture->getCube());
    glBegin(GL_QUADS);
    //  Front
    glNormal3f(0, 0, 1);
    glTexCoord2f(0, 0);
...
void Companion::sidePanel()
{
    ...
    glBindTexture(GL_TEXTURE_2D, texture->getEdge());
    glColor3f(1, 1, 1);
    glBegin(GL_QUADS);
    //corner
    glNormal3f(0, 1, 1);
...
void Companion::cornerPanel()
{
    ...
    glBindTexture(GL_TEXTURE_2D, texture->getWood());
...
void Companion::cylinder(GLint angleChange, GLdouble radius, GLdouble height)
{
    ...
    glBindTexture(GL_TEXTURE_2D, texture->getMetal());
    glPushMatrix();
