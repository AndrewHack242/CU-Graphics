...
{
   //  Initialize GLFW
   GLFWwindow* window = InitWindow("HW1: Andrew Hack",1,600,600,&reshape,&key);

   //  Load shader
   shader = CreateShaderProg("shaders/colorMap.vert","shaders/colorMap.frag");
